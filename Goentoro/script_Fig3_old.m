% script_Fig3
%
% This script is "old" because it was before we reorganized it to make it
...
% % pcolor_contour(K11,K22,log10(K12_NPA_FBL(:,:,2)),[0 0.15 0.3 1],'r',true,-6,-0.7)
...
%
load Mat/Fig3_FBL_K12NPA_K1K2sweep K1_I_FBL K2_I_FBL K1_II_FBL K2_II_FBL 
